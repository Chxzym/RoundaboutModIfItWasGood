...
public class ChairRattRenderer extends StandRenderer<ChairRattEntity> {
    ...
    private static final ResourceLocation MECH_RAT_SKIN = new ResourceLocation(Roundabout.MOD_ID,"textures/stand/ratt/mech_chair.png");
    ...
    public ResourceLocation getTextureLocation(ChairRattEntity entity) {
        return switch (entity.getSavedSkin()) {
            case RattEntity.KING_RAT_SKIN -> KING_RAT_SKIN;
            case RattEntity.MECH_RAT_SKIN -> MECH_RAT_SKIN;
            default -> CHAIR_SKIN;
        };
